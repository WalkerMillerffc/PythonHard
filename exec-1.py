#Exercício 1) Escreva um algoritmo que armazene o valor 10 em uma variável A e o valor 20 em uma variável B.
...
A = 10
B = 20
print(A, "valor da variavel A")
print(B, "valor da variavel B")
temporaria = A
A = B
B = temporaria
print(A, "valor da variavel A")
